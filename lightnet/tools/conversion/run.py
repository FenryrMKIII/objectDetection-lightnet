# taken from https://github.com/ultralytics/JSON2YOLO
...
def convert_coco_json(json_dir='../coco/annotations/'):
    ...
    jsons = Path(json_dir).rglob('*.json')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', '--anno', help='Path to annotations directory')
